...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  void initState() {
    ...
    super.initState();
    Provider.of<FirebaseProvider>(context,listen: false).userNameController.text = Provider.of<FirebaseProvider>(context,listen: false).appUser!.userName;
    Provider.of<FirebaseProvider>(context,listen: false).emailController.text = Provider.of<FirebaseProvider>(context,listen: false).appUser!.email;
    Provider.of<FirebaseProvider>(context,listen: false).phoneController.text = Provider.of<FirebaseProvider>(context,listen: false).appUser!.phone;
    Provider.of<FirebaseProvider>(context,listen: false).passwordController.text = Provider.of<FirebaseProvider>(context,listen: false).appUser!.password!;
  }
  @override
